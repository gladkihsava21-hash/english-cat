...
<main class="credits">
  ...
  <!-- Блок живёт В ШАБЛОНЕ генератора: однажды его добавили руками в
       credits.html, и следующий прогон build_images.py молча его стёр —
       условия CEFR-J требуют указания источника, терять нельзя. -->
  <p>Уровни слов A1–B2 расставлены по
    <a href="https://cefr-j.org/" rel="noopener" target="_blank">CEFR-J Wordlist Version 1.6</a>
    (compiled by Yukio Tono, Tokyo University of Foreign Studies; получено с cefr-j.org 17.08.2026,
    используется с указанием источника). Частотность для редких слов — по
    OpenSubtitles (hermitdave/FrequencyWords, CC BY-SA 4.0) и Google Books (norvig.com).</p>
  <p>Транскрипция слов — по
    <a href="http://www.speech.cs.cmu.edu/cgi-bin/cmudict" rel="noopener" target="_blank">CMU
    Pronouncing Dictionary</a> (Carnegie Mellon University, лицензия BSD-2),
    американский вариант произношения; запись ARPAbet переведена в знаки МФА.</p>
  <table>
    <thead>
