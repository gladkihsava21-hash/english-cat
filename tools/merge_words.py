...
REJECT_WORD_RE = re.compile(
    r"(нагот|голы[йе]\b|секс|эроти|порно|мастурб|гениталь|"
    r"труп|убий|казн|пытк[аи]\b|смирительн|"
    r"наркот|алкогол|пьян|водк|проститу|изнасил|суицид|самоубий|аборт)",
    re.I)
