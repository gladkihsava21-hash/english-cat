...
Собрано 21.08.2026 01:44. Скрипт: `tools/build_images.py`.
...
| Картинок получено | **389** |
| Отброшено на сборке | 320 |
| Вынесено вам на решение | 15 |
| Общий вес `img/words/` | 7104 КБ (6.9 МБ) |
| Средняя плитка | 17.8 КБ |
| Самая тяжёлая | 39.8 КБ |
| Запросов: сеть / кэш / ошибки | 0 / 1730 / 0 |
| Время прогона | 8 с |

Самые тяжёлые плитки: branch 39.8 КБ, rescue 39.4 КБ, jungle 39.3 КБ, volunteer 39.0 КБ, tiger 39.0 КБ.
...
## Отобраны, но фотографии не нашлось (353)
