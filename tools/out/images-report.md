...
Собрано 21.08.2026 01:07. Скрипт: `tools/build_images.py`.
...
| Картинок получено | **386** |
| Отброшено на сборке | 317 |
| Вынесено вам на решение | 15 |
| Общий вес `img/words/` | 7041 КБ (6.9 МБ) |
| Средняя плитка | 17.8 КБ |
| Самая тяжёлая | 39.8 КБ |
| Запросов: сеть / кэш / ошибки | 0 / 1718 / 0 |
| Время прогона | 8 с |
...
## Отобраны, но фотографии не нашлось (297)
