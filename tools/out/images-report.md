...
Собрано 14.09.2026 11:10. Скрипт: `tools/build_images.py`.

## Цифры

| | |
|---|---|
| Слов в базе `js/words.js` | 2597 |
| Из них отобрано под фотографию | 184 |
| Картинок получено | **510** |
| Отброшено на сборке | 320 |
| Вынесено вам на решение | 15 |
| Общий вес `img/words/` | 9232 КБ (9.0 МБ) |
| Средняя плитка | 17.4 КБ |
| Самая тяжёлая | 39.8 КБ |
| Запросов: сеть / кэш / ошибки | 0 / 1730 / 0 |
| Время прогона | 8 с |

Самые тяжёлые плитки: branch 39.8 КБ, rescue 39.4 КБ, jungle 39.3 КБ, shamrock 39.2 КБ, volunteer 39.0 КБ.
...
| allegro | поиск | file:Anna Bon di Venezia, Flöten-Sonate IV- Andante und Anfang Allegro assai1Untitled3.jpg: не современное фото: категория Commons «1756 works» (Anna Bon di Venezia, Flöten-Sonate  |
| anachronism | поиск | Anachronism: не современное фото: категория Commons «PD-old» (Cesare_Gennari_Orfeo.jpg) |
| analysis | поиск | file:Adriaen Van Ostade - L'Analyse - PDUT921 - Musée des Beaux-Arts de la ville de Paris.jpg: не современное фото: категория Commons «Paintings» (Adriaen Van Ostade - L'Analyse -  |
| anonymous | поиск | file:Image of none.svg: SVG — это рисунок или схема, не фотография (Image of none.svg) |
| antigen | поиск | Antigen: не современное фото: категория Commons «diagrams» (Antibody.svg) |
| antiquarian | поиск | file:Johann Bauer Antiquitätenhändler.jpg: не современное фото: категория Commons «19th-century» (Johann Bauer Antiquitätenhändler.jpg) |
...
| beam | поиск | file:Balken.jpg: не современное фото: категория Commons «Diagrams» (Balken.jpg) |
| bear | поиск | Bear: лицензия вне белого списка (FAL) (Ours_brun_parcanimalierpyrenees_1.jpg) |
| bedroom | поиск | Bedroom: лицензия вне белого списка (FAL) (Berlin_Villa_Borsig_Tegel_asv2019-08_img09.jpg) |
...
| black | поиск | file:Color icon black.svg: по имени файла это схема/карта/логотип (Color icon black.svg) |
| blade | поиск | file:Whale knife hg.jpg: панорама 2436x570 — квадратная обрезка потеряет сюжет (Whale knife hg.jpg) |
...
| blue | поиск | file:Color icon blue.svg: по имени файла это схема/карта/логотип (Color icon blue.svg) |
| body | поиск | file:The human body and health - an elementary text-book of essential anatomy, applied physiology and practical hygiene for schools (1908) (14586547287).jpg: по имени файла это схе |
| border | поиск | file:Finnish border sign Kilpisjarvi.JPG: по имени файла это схема/карта/логотип (Finnish border sign Kilpisjarvi.JPG) |
...
| brown | поиск | file:Color icon brown.svg: по имени файла это схема/карта/логотип (Color icon brown.svg) |
...
| channel | поиск | file:Comm Channel.svg: SVG — это рисунок или схема, не фотография (Comm Channel.svg) |
...
| clan | поиск | file:Clan Chattan lands affected by Earldoms circa 17th century.jpg: не современное фото: категория Commons «Maps» (Clan Chattan lands affected by Earldoms circa 17th century.jpg) |
...
| controversy | поиск | file:Meggendorfer Wenn Gelehrte streiten.jpg: не современное фото: категория Commons «PD Old» (Meggendorfer Wenn Gelehrte streiten.jpg) |
...
| corporation | поиск | file:Ralph Allen making a speech to the Corporation of Bath. Wellcome V0011283.jpg: не современное фото: категория Commons «Etchings» (Ralph Allen making a speech to the Corporatio |
| country | поиск | Country: по имени файла это схема/карта/логотип (Official_United_Nations_World_Map_-_October_2022.svg) |
| courage | поиск | file:Raevsky saltanovka.jpg: не современное фото: категория Commons «PD-old» (Raevsky saltanovka.jpg) |
...
| cushion | поиск | file:Cushions.jpg: слишком мелкий оригинал (300x331) (Cushions.jpg) |
...
| desire | поиск | file:Jacob Jordaens - Susanna and the Elders - Google Art Project.jpg: не современное фото: категория Commons «PD-old» (Jacob Jordaens - Susanna and the Elders - Google Art Project |
...
| disk | поиск | file:Disko.png: слишком мелкий оригинал (379x161) (Disko.png) |
| doubt | поиск | file:Rae, Henrietta - Doubts - 1886.jpg: не современное фото: категория Commons «1905 paintings» (Rae, Henrietta - Doubts - 1886.jpg) |
...
| elite | поиск | file:The Royal Feast of Belshazzar Blaine and the Money Kings (1884).jpg: не современное фото: категория Commons «PD-old» (The Royal Feast of Belshazzar Blaine and the Money Kings  |
...
| enlightenment | поиск | file:We grow wiser as we grow older - K. LCCN2010651404.jpg: не современное фото: категория Commons «PD-old» (We grow wiser as we grow older - K. LCCN2010651404.jpg); file:PuckMaga |
| ensemble | поиск | file:John Galliano ensemble. Dress of the Year, 1987.jpg: панорама 690x2048 — квадратная обрезка потеряет сюжет (John Galliano ensemble. Dress of the Year, 1987.jpg) |
| enterprise | поиск | file:Wolfsburg VW-Werk.jpg: ограничения на использование (trademarked) (Wolfsburg VW-Werk.jpg) |
...
| ethics | поиск | file:Rage-and-anger-fresco.jpg: не современное фото: категория Commons «18th-century» (Rage-and-anger-fresco.jpg) |
| evacuation | поиск | ru:Эвакуация: не современное фото: категория Commons «PD Old» (White_army_departure.jpg) |
| evolution | поиск | file:L'origine de l'évolution.jpg: не современное фото: категория Commons «in art» (L'origine de l'évolution.jpg) |
...
| explorer | поиск | file:Landing of Columbus (2).jpg: не современное фото: категория Commons «PD-old» (Landing of Columbus (2).jpg) |
...
| female | поиск | file:Venus symbol.svg: по имени файла это схема/карта/логотип (Venus symbol.svg) |
| fiction | поиск | Fiction: не современное фото: категория Commons «illustrations of» (Alice_par_John_Tenniel_25.png) |
| field | поиск | file:VFPt charges plus minus thumb.svg: SVG — это рисунок или схема, не фотография (VFPt charges plus minus thumb.svg) |
| filter | поиск | file:FilterDiagram.svg: не современное фото: категория Commons «Diagrams» (FilterDiagram.svg) |
| fingerprint | поиск | Fingerprint: слишком мелкий оригинал (215x319) (Fingerprintforcriminologystubs.jpg) |
| fist | поиск | file:Human fist from three sides.jpg: не современное фото: категория Commons «in art» (Human fist from three sides.jpg) |
...
| fundamental | поиск | file:Root of a major chord on C.png: слишком мелкий оригинал (539x252) (Root of a major chord on C.png) |
...
| giant | поиск | file:DnD Giant.png: не современное фото: категория Commons «in art» (DnD Giant.png) |
...
| graffiti | поиск | file:Kartu Chufu01.JPG: не современное фото: категория Commons «PD Old» (Kartu Chufu01.JPG) |
| green | поиск | file:Color icon green.svg: по имени файла это схема/карта/логотип (Color icon green.svg) |
...
| household | поиск | file:Aime Pez Familienidylle 1839.jpg: не современное фото: категория Commons «1839 paintings» (Aime Pez Familienidylle 1839.jpg) |
...
| idea | поиск | file:Pictofigo - Idea.png: слишком мелкий оригинал (225x250) (Pictofigo - Idea.png) |
...
| immigration | поиск | file:Inmigrantes europeos llegando a Argentina.jpg: не современное фото: категория Commons «19th century» (Inmigrantes europeos llegando a Argentina.jpg) |
| inequality | поиск | file:Linear Programming Feasible Region.svg: SVG — это рисунок или схема, не фотография (Linear Programming Feasible Region.svg) |
...
| intellectual | поиск | file:Goethe (Stieler 1828).jpg: не современное фото: категория Commons «PD-old» (Goethe (Stieler 1828).jpg) |
...
| jury | поиск | file:The Jury (1861).jpg: не современное фото: категория Commons «1861 paintings» (The Jury (1861).jpg) |
...
| lead | поиск | file:Lead electrolytic and 1cm3 cube.jpg: лицензия вне белого списка (FAL) (Lead electrolytic and 1cm3 cube.jpg) |
| legacy | поиск | ru:Наследование (право): не современное фото: категория Commons «PD-old» (Nevrev_b_005.jpeg) |
| legislature | поиск | file:Palace of Westminster, London - Feb 2007.jpg: панорама 3200x1261 — квадратная обрезка потеряет сюжет (Palace of Westminster, London - Feb 2007.jpg) |
...
| luck | поиск | file:A postcard illustrating a soldier sending good luck and wish Wellcome V0016596.jpg: не современное фото: категория Commons «in art» (A postcard illustrating a soldier sending  |
| lung | поиск | Lung: по имени файла это схема/карта/логотип (Lungs_diagram_detailed.svg) |
| lyrics | поиск | file:Song lyrics about Namazu, the giant catfish who causes earthquakes (13470133804).jpg: несвободная лицензия (No restrictions) (Song lyrics about Namazu, the giant catfish who c |
...
| memory | поиск | file:Ripa - Iconologie - 1643 - p. 107- memoire.jpg: не современное фото: категория Commons «in art» (Ripa - Iconologie - 1643 - p. 107- memoire.jpg) |
| merchant | поиск | file:A merchant making up the account.jpg: не современное фото: категория Commons «Paintings» (A merchant making up the account.jpg) |
...
| motion | поиск | file:Simple harmonic oscillator.gif: формат gif (Simple harmonic oscillator.gif) |
...
| normal | поиск | file:Normal vectors2.svg: SVG — это рисунок или схема, не фотография (Normal vectors2.svg) |
...
| opposition | поиск | file:Positional astronomy.svg: не современное фото: категория Commons «sketches» (Positional astronomy.svg) |
...
| peace | поиск | file:Peace dove.svg: SVG — это рисунок или схема, не фотография (Peace dove.svg) |
...
| pharmacy | поиск | ru:Аптека: не современное фото: категория Commons «PD-Art» (42-aspetti_di_vita_quotidiana,_medicine,_Taccuino_Sanitatis.jpg); Pharmacy: не современное фото: категория Commons «in a |
...
| player | поиск | file:Ernest Cadine pratiquant un exercice d'haltérophilie, Agence Rol, btv1b53098358j.jpg: не современное фото: категория Commons «1923 photographs» (Ernest Cadine pratiquant un ex |
| pleasure | поиск | file:EdisonDelights1905.jpg: не современное фото: категория Commons «Paintings» (EdisonDelights1905.jpg) |
| poet | поиск | ru:Поэт: файл не с Commons (вероятно fair use) |
| police | поиск | file:HH Polizeihauptmeister MZ.jpg: ограничения на использование (personality) (HH Polizeihauptmeister MZ.jpg) |
...
| province | поиск | file:Map of country subdivisions (provinces).svg: по имени файла это схема/карта/логотип (Map of country subdivisions (provinces).svg) |
...
| reception | поиск | file:Délégation vénitienne à Damas (musée du Louvre) (6358418295).jpg: не современное фото: категория Commons «15th-century» (Délégation vénitienne à Damas (musée du Louvre) (63584 |
| red | поиск | file:Color icon red.svg: по имени файла это схема/карта/логотип (Color icon red.svg) |
| reed | поиск | ru:Камыш: не современное фото: категория Commons «drawings» (Scirpus_sylvaticus_(Leningrad_oblast).jpg) |
| region | поиск | file:Mediterranian Sea Carthago location.JPG: не современное фото: категория Commons «Maps» (Mediterranian Sea Carthago location.JPG) |
| regret | поиск | file:Hans Thoma - Der verlorene Sohn.jpg: не современное фото: категория Commons «1885 paintings» (Hans Thoma - Der verlorene Sohn.jpg) |
| religion | поиск | Religion: по имени файла это схема/карта/логотип (Icon-religion.svg) |
| republic | поиск | file:Forms of government.svg: не современное фото: категория Commons «maps» (Forms of government.svg) |
...
| rhythm | поиск | file:8beat example 01.jpg: слишком мелкий оригинал (554x194) (8beat example 01.jpg) |
...
| snapshot | поиск | file:Snapper root list screenshot.png: по имени файла это схема/карта/логотип (Snapper root list screenshot.png) |
...
| symbol | поиск | file:ReligijneSymbole.svg: SVG — это рисунок или схема, не фотография (ReligijneSymbole.svg) |
| system | поиск | file:Primäres System.png: несвободная лицензия (Copyrighted free use) (Primäres System.png) |
...
| trap | поиск | file:Pinchout.jpg: не современное фото: категория Commons «diagrams» (Pinchout.jpg) |
...
| vulnerable | поиск | file:Status iucn3.1 VU-ca.svg: не современное фото: категория Commons «diagrams» (Status iucn3.1 VU-ca.svg) |
...
| wedge | поиск | file:Geometric wedge.png: слишком мелкий оригинал (314x153) (Geometric wedge.png) |
| week | поиск | Week: по имени файла это схема/карта/логотип (First_Day_of_Week_World_Map.svg) |
| white | поиск | file:Color icon white.svg: по имени файла это схема/карта/логотип (Color icon white.svg) |
...
| wing | поиск | file:Duerer wing of a blue roller.jpg: не современное фото: категория Commons «PD-old» (Duerer wing of a blue roller.jpg) |
...
| yellow | поиск | file:Color icon yellow.svg: по имени файла это схема/карта/логотип (Color icon yellow.svg) |
...
## Отобраны, но фотографии не нашлось (341)
...
| acquaintance | знакомый | трое сидящих мужчин — не читается |
...
| article | статья | старая газета — читается как «газета» |
| attention | внимание | ч/б станок |
| auction | аукцион | зал с ведущим — «выступление» |
| aunt | тётя | женщина с ребёнком — прочитают «мама» |
| authority | власть, органы власти | здание суда с колоннами |
| avenue | проспект | ночной неон — читается как «город ночью» |
| bag | сумка, пакет | лид Plastic bag — пакет на урне, читается как «мусорка» |
| base | база | бетонный колодец |
| behavior | поведение | дерущиеся антилопы |
| birth | рождение | окот овцы — прочитают «овца» |
| blackmail | шантаж | записка с фотографиями |
| blindfold | повязка на глаза | барельеф Фемиды |
| boot | сапог | то же фото, что boots |
| brake | тормоз | колесо мотоцикла — читается как «колесо» |
| bride | невеста | старинное ч/б фото пары |
| bridegroom | жених | старинное ч/б фото пары |
| building | здание | лид скачет между музейной избой и случайным домом; слово слишком общее |
| burn | гореть, жечь | ожог на коже крупно — неприятно детям |
| business | бизнес | улица с палатками |
| buttermilk | пахта | стаканы молока — читается как milk |
| cable | кабель, провод | витой канат — читается как rope |
...
| challenge | вызов, трудная задача | ноги на шарах |
| championship | чемпионат | празднующая команда — читается как basketball |
| chef | шеф-повар | повар — не отличить от cook |
| class | класс | дети рисуют на улице |
...
| community | сообщество | фестиваль с колесом обозрения |
| company | компания | групповое фото рабочих — «команда» |
| competition | состязание | бодающиеся олени — читается как deer |
| component | компонент | металлические детали — конфликт detail |
| computer | компьютер | и Desktop computer — ретро-терминал 80-х; не опознают |
| connection | соединение | мост |
| consent | согласиться | плакат с английским текстом |
| conservative | консервативный | гравюра-портрет |
| consultant | консультант | девушка с микрофоном |
| cosmology | космология | звёздное поле — читается как «космос» |
| costume | костюм | манекен в странном костюме |
| counter | счётчик | схема с французским текстом |
| court | суд | лид Courtyard — двор мечети, читается как «мечеть» |
| courthouse | здание суда | дворец правосудия — «здание» |
| cruise | круиз | парусник — читается как boat |
| culture | культура | наскальная живопись |
| currency | валюта | купюры — читается как money |
| custom | обычай | мужчина у мангала |
| cut | порезать | порезы на коже — жесть, детям нельзя |
| daddy | папа | то же фото, что father (обе статьи — Father) |
| dancer | танцор | то же фото, что dance |
| danger | опасность | этикетка с текстом |
| database | база данных | скриншот SQL-текста |
| daughter | дочь | ч/б семейное фото |
| dawn | рассвет | рассвет — не отличить от morning |
| dealer | торговец | статуя Меркурия |
| dean | декан | рукопожатие |
...
| device | устройство | военная рация — милитари |
| diagnosis | диагноз | микроскопия |
| dial | циферблат | настенные часы — не отличить от clock |
| diet | диета | стол с продуктами — читается как food |
| differential | дифференциальный | шестерни — «механизм» |
| dingo | динго | читается как dog |
| director | директор, режиссёр | ч/б съёмочная группа |
| dirt | грязь | нога в грязи — то же, что mud |
| dislike | не любить | то же фото, что anger (спорящий мужчина) |
| documentary | документальный | мужчина с веслом |
...
| efficiency | эффективность | плакат с текстом |
| elder | старший | ч/б портрет |
| encounter | встретить | караван верблюдов |
...
| etiquette | этикет | кадр немого кино с титрами |
| euthanasia | эвтаназия | усыпление крысы — жесть |
| evaluation | оценка | солдаты в лесу |
| exit | выход | старинная открытка |
| explanation | объяснение | макет в темноте |
| fact | факт | стеллажи «Fakta» — текст |
...
| flesh | плоть, мякоть | нарезка мяса — читается как «мясо» |
...
| form | форма | наборная касса |
| formation | формирование | ч/б строй солдат |
| fuel | топливо | горящие дрова — «огонь» |
| function | функция | 3D-график |
...
| genius | гений | античная голова |
| geology | геология | Гранд-Каньон — читается как «каньон» |
| gill | жабры | жабры с кровью — мясное, пугает |
| goal | цель | плакат с текстом |
...
| gray | серый | серый глаз — то же, что eye |
| groceries | продукты | то же фото, что shop (Westside Market) |
| group | группа | кубик Рубика (сущность — математическая группа) |
| grove | роща | осенние деревья — читается как forest |
| guest | гость | человек на конференции |
| habit | привычка | ч/б у двери |
| haircut | стрижка | японская причёска гейши |
| hand | рука, кисть руки | en:Hand — ограничение personality rights, ru:Кисть — атлас Грея |
| handle | ручка | рука со стаканчиком |
| hardware | оборудование, железо | кирпичная кладка |
...
| improvisation | импровизация | хористы |
| incense | благовония | кусочки смолы — не читается |
| incentive | стимул, поощрение | мама с младенцем |
| income | доход | график с русскими подписями |
| information | информация | синий куб — абстракция |
| institution | учреждение | здание музея |
| interior | внутренний | ч/б разрушенный интерьер |
| interrogation | допрос | пустой офис |
| investigation | расследование | мутная комната |
| investment | вложение, инвестиция | стройка — читается как construction |
...
| jet | реактивный самолёт | тёмный стенд с паром |
...
| mandarin | мандарин | статуи чиновников-мандаринов — не фрукт |
| mandolin | мандолина | читается как guitar |
| marrow | костный мозг | схема кости |
| material | материал | руки с картами |
| mayor | мэр | ч/б церемония |
| member | член | двое на скамейке |
| men | мужчины | одинокий абориген — не «люди», и то же фото у person |
| midnight | полночь | башенные часы днём — читается как clock |
| miller | мельник | ч/б старина |
| ministry | министерство | группа в форме |
| mirror | зеркало | единственный свободный лид 300×308 — мельче плитки |
| monopoly | монополия | китайская вывеска |
...
| opinion | мнение | стикеры с текстом |
| ore | руда | полосатый камень — читается как «камень» |
| organism | организм | микроскопия бактерий |
| outcome | итог, исход | ягода на пальце |
| oven | духовка | и ru:Духовой шкаф — старая общепитовская плита, мрачно |
| oxygen | кислород | голубая жидкость в стакане |
| pack | упаковывать | упаковки с русским текстом |
| pact | соглашение | документ с текстом |
| pain | боль | рисунок рук, не читается |
| panel | панель | деревянный складень |
| paradigm | парадигма, модель | схема |
| pastry | выпечка | сырое тесто — читается как «тесто» |
| pension | пенсия | музейный стенд с текстом |
...
| pick | выбирать | тёмное нечитаемое |
| pipe | труба, трубка | деревянные флейты — не «труба» |
| pity | сочувствие | девочка обнимает малыша — читается как hug |
| plan | план | чертёж со схемой и надписями |
...
| politics | политика | зал ООН — «конференция» |
| poor | бедный | люди с коляской — не читается и этически сомнительно |
| power | власть | политик на трибуне — personality |
| prescription | рецепт | бланк «Рецепт» — русский текст |
| president | президент | четыре президента США — лица знаменитостей |
| principle | принцип | диаграмма |
| problem | проблема | слайд с текстом |
| professional | профессиональный, профессионал | врач с пациентами — читается как doctor |
| progress | прогресс, успехи | обложка WOMAN'S PROGRESS — английский текст в кадре |
| project | проект | очередь в поле |
| promise | обещать, обещание | пропагандистские комиксы |
| public | общественный | люди у канала |
...
| quality | качество | mind-map |
| rail | перила | лестничные перила |
| rally | митинг | митинг — не отличить от crowd |
...
| regulation | правило | лабораторный прибор |
...
| roommate | сосед по комнате | две девушки на диване — «подруги», конфликт friend |
| ruin | разрушить, испортить | обломанные колонны — не отличить от column |
| rule | правило | комната с камином |
...
| service | услуга | взвод солдат |
| shape | форма | тень на стене |
| shelter | укрытие | беседка в парке — «беседка» |
| sheriff | шериф | ч/б групповое фото |
| shore | берег | то же фото, что coast (одна статья Coast) |
| shuttle | шаттл, челнок | ткацкий челнок — «станок» |
...
| size | размер | гаечные ключи — «ключи» |
| skill | навык, умение | вышитая коробочка |
| skin | кожа | кожа слона — читается как «слон» |
| sleeve | рукав | ч/б дама с велосипедом |
| sniffles | насморк | пинцет |
| society | общество | дети на пикнике |
| software | программное обеспечение | скриншот кода |
| spy | шпион | ч/б пара в форме |
| stable | устойчивый, стабильный | сарай — не отличить от barn, лошадь еле видна |
| star | звезда | диск Солнца — то же, что sun |
| stone | камень | Гранд-Каньон — читается как «горы/каньон» |
| store | магазин | складские стеллажи |
| strategy | стратегия | плакат с текстом |
| string | верёвка | витой шнур — читается как rope, перевод тот же «верёвка» |
| studio | студия | пустая мастерская с мольбертами |
| suffer | страдать | трагическая маска-горгулья — читается как mask |
| supervisor | руководитель | пустой ресепшн |
| suspect | подозревать | тёмная сцена |
| swine | свинья | кабаны — читается как pig |
| symptom | симптом | отёкшие ноги — медицина |
| syntax | синтаксис | дерево разбора — схема |
| table | стол | и Table (furniture) — снова музейный антиквариат |
| tail | хвост | хвост оленя — читается как deer |
| tale | сказка | сепия-гравюра |
| tax | налог | монеты — читается как coin |
| teacher | учитель | и ru:Учитель — то же общее фото за столом |
| teahouse | чайная | интерьер — читается как «комната» |
| technical | технический | статья Technical — военный пикап с пулемётом |
...
| vice | порок | микрофоны в витрине |
| vinegar | уксус | полки с бутылками — читается как «магазин» |
| voice | голос | спектрограмма |
| void | пустота | карта космической пустоты |
| walk | ходить пешком, гулять | en:Walking — personality rights, ru:Ходьба — файл не с Commons |
| wall | стена | и Brickwork — фигурная кирпичная колонна, не стена |
| warning | предупреждение | табличка с французским текстом |
| weather | погода | гроза над пирсом — не отличить от lightning и storm |
| weekend | выходные | купание у свалки |
| winner | победитель | ч/б фехтовальщик со спины |
| witness | свидетельство, свидетель | ч/б за столом |
| word | слово | табличка с маорийским словом — текст |
| world | мир | звёздное поле Хаббла — читается как «космос» |
| write | писать | лид — рукопись, то есть текст в кадре; подсказывает буквы, а не слово |
| yeast | дрожжи | микроскопия клеток |
