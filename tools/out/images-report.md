...
Собрано 14.08.2026 16:21. Скрипт: `tools/build_images.py`.

## Цифры

| | |
|---|---|
| Слов в базе `js/words.js` | 554 |
| Из них отобрано под фотографию | 122 |
| Картинок получено | **110** |
| Отброшено на сборке | 12 |
| Вынесено вам на решение | 15 |
| Общий вес `img/words/` | 3045 КБ (3.0 МБ) |
| Средняя плитка | 27.2 КБ |
| Самая тяжёлая | 40.0 КБ |
| Запросов: сеть / кэш / ошибки | 0 / 387 / 0 |
| Время прогона | 7 с |

Самые тяжёлые плитки: park 40.0 КБ, luggage 40.0 КБ, wallet 39.8 КБ, swim 39.6 КБ, bank 39.6 КБ.
