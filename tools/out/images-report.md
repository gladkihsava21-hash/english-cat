...
Собрано 21.08.2026 09:07. Скрипт: `tools/build_images.py`.
...
| Картинок получено | **475** |
| Отброшено на сборке | 320 |
| Вынесено вам на решение | 15 |
| Общий вес `img/words/` | 8588 КБ (8.4 МБ) |
| Средняя плитка | 17.5 КБ |
...
| acquaintance | знакомство | трое сидящих мужчин — не читается |
...
| burn | ожог, ручей | ожог на коже крупно — неприятно детям |
...
| material | материальный | руки с картами |
...
| shuttle | челнок | ткацкий челнок — «станок» |
...
| void | пустой | карта космической пустоты |
...
| word | слова | табличка с маорийским словом — текст |
