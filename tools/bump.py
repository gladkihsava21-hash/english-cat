...
Версия живёт в СЕМИ местах: пять html (PAGES ниже), sw.js и server.py.
Пока их правили руками, sw.js отставал — на момент написания скрипта
в html стояло v=90, а
...
PAGES = ["index.html", "tutor.html", "admin.html", "board.html", "faq.html"]
