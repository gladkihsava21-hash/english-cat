...
// Ступени наклеек — три ступени светлоты одного шалфея (бронза светлее,
// золото — заливка акцентом в полную силу). Имена классов остались от
// старой пастельной гаммы, а раскраска живёт в a11y.css: переименовать
// класс = переписать три правила, поэтому имена не трогаем.
