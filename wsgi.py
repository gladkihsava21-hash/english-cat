...
# была просто щедростью. Куки не используются, но сужение бесплатно.
CORS = [("Access-Control-Allow-Origin", "https://wordcat.ru")]
...
def application(environ, start_response):
    ...
    работа (server.housekeeping: напоминания на почту и уборка протухшего
    сигналинга звонков).
